...
func spawn_troops():
	...
	if day_count >= 2:
		var swordsman_count = floor(day_count / 0.7)
	...
	if day_count >= 20:
		var wizard_count = -10 + floor(day_count / 1.8)
